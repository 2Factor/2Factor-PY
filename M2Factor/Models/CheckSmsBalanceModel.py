...
"""
   M2Factor.Models.CheckSmsBalanceModel
...
class CheckSmsBalanceModel(object):

    """Implementation of the 'check-sms-balance-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the CheckSmsBalanceModel class
