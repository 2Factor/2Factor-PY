...
"""
   M2Factor.Models.VerifyOtpInputModel
...
class VerifyOtpInputModel(object):

    """Implementation of the 'verify-otp-input-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the VerifyOtpInputModel class
