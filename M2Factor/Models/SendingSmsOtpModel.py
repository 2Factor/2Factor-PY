...
"""
   M2Factor.Models.SendingSmsOtpModel
...
class SendingSmsOtpModel(object):

    """Implementation of the 'sending-sms-otp-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the SendingSmsOtpModel class
