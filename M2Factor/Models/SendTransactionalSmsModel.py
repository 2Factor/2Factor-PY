...
"""
   M2Factor.Models.SendTransactionalSmsModel
...
class SendTransactionalSmsModel(object):

    """Implementation of the 'send-transactional-sms-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the SendTransactionalSmsModel class
