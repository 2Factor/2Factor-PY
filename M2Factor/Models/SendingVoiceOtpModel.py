...
"""
   M2Factor.Models.SendingVoiceOtpModel
...
class SendingVoiceOtpModel(object):

    """Implementation of the 'sending-voice-otp-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the SendingVoiceOtpModel class
