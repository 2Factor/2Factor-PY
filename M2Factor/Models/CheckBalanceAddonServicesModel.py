...
"""
   M2Factor.Models.CheckBalanceAddonServicesModel
...
class CheckBalanceAddonServicesModel(object):

    """Implementation of the 'check-balance-addon-services-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the CheckBalanceAddonServicesModel class
