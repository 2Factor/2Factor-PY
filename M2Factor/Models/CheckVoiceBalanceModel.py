...
"""
   M2Factor.Models.CheckVoiceBalanceModel
...
class CheckVoiceBalanceModel(object):

    """Implementation of the 'check-voice-balance-model' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the CheckVoiceBalanceModel class
